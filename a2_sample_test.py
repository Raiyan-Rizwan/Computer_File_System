...
if __name__ == '__main__':
    ...
    # if self.data_size == 0:
    #     self.rect = (0, 0, 0, 0)
    # elif not self._subtrees:  # if our current object is a leaf
    #     self.rect = rect
    # else:
    #     self.rect = rect
    #     parent_tree_size = self.data_size
    #     width = rect[2]
    #     height = rect[3]
    #     # we put <x> and <y> outside because it changes as we move through
    #     # subtrees of <self>.
    #     x = rect[0]
    #     y = rect[1]
    #     if width > height:  # make vertical rectangles
    #         temp_x = x
    #         for subtree in self._subtrees:
    #             if subtree != self._subtrees[-1]:
    #                 percentage = subtree.data_size / parent_tree_size
    #                 rect2 = list(rect)  # make <rect> mutable
    #                 rect2[2] = math.floor(
    #                     percentage * rect2[2])  # changing the width
    #             else:
    #                 rect2 = list(rect)  # make <rect> mutable
    #                 rect2[2] = rect2[2] + rect[
    #                     0] - temp_x  # changing the width
    #             new_rect = (temp_x, rect2[1], rect2[2], rect2[3])
    #             subtree.update_rectangles(new_rect)
    #             temp_x += rect2[
    #                 2]  # next subtree, we assign rect with higher x
    #             # value
    #     elif height >= width:  # make horizontal rectangles
    #         temp_y = y
    #         for subtree in self._subtrees:
    #             if subtree != self._subtrees[-1]:
    #                 percentage = subtree.data_size / parent_tree_size
    #                 rect2 = list(rect)  # make <rect> mutable
    #                 rect2[3] = math.floor(
    #                     percentage * rect2[3])  # changing height
    #             else:
    #                 rect2 = list(rect)
    #                 rect2[3] = rect2[3] + rect[
    #                     1] - temp_y  # changing height
    #             new_rect = (rect[0], temp_y, rect2[2], rect2[3])
    #             subtree.update_rectangles(new_rect)
    #             temp_y += rect2[3]  # next subtree, we assign rect with
    #             # higher y value
